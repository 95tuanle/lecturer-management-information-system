...
<div class="container-fluid">
  <form action=" <?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?> " method="post">
    ...
    <div class="form-group">
      <input placeholder="First name" class="form-control" type="text" name="fname"
    ...
    <div class="form-check">
      <input type="radio" name="gender" value="F" <?php if ($_POST['gender'] == "F") {
          echo "checked";
      } ?> id="F">
      <label for="F">Female</label>
      <input type="radio" name="gender" value="M" <?php if ($_POST['gender'] == "M") {
          echo "checked";
      } ?> id="M">
    ...
    <div class="form-group">
      <input placeholder="Age" class="form-control" type="number" name="age"
